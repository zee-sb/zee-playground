...
export function apply(blueprint, options = {}) {
  ...
  // Search sources: one per Expert that has knowledgeSources. The wizard
  // emits them as `kind: 'search'` connections wired to /api/mcp-kb so they
  // appear in the Connections tab and become selectable in the detail picker.
