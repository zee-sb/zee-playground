...
export const CONNECTORS = [
  ...
  },
  {
    id: 'servicenow',
    name: 'ServiceNow',
    description: 'Real ServiceNow ITSM on the linked account — search the knowledge base and view/create/update incidents. Per-user OAuth; ServiceNow enforces the user\'s own roles on every call.',
    kind: 'internal',
    ...
    domains: [
      'servicenow', 'service now', 'snow', 'itsm', 'incident', 'incident number',
      'ticket status', 'open ticket', 'my tickets', 'case', 'outage',
      'knowledge base', 'kb article', 'how do i', 'it request', 'service request',
      'change record', 'change management', 'work note',
    ],
  },
];
