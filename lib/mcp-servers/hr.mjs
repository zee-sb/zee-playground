...
const EMPLOYEES = [
  { id: 'zee',   name: 'Zee Abuzeid',  email: 'zyad.abuzeid@staffbase.com', role: 'employee', department: 'Product',     title: 'Senior Product Manager', manager: 'carol.davis@staffbase.com', ptoBalance: 17, location: 'Berlin',        region: 'DE', startDate: '2024-02-12' },
  { id: 'alice', name: 'Alice Chen',   email: 'alice.chen@staffbase.com',   role: 'hr_admin', department: 'People',      title: 'HR Manager',             manager: null,                        ptoBalance: 18, location: 'San Francisco', region: 'US', startDate: '2019-03-15' },
  { id: 'bob',   name: 'Bob Smith',    email: 'bob.smith@staffbase.com',    role: 'employee', department: 'Engineering', title: 'Software Engineer',      manager: 'carol.davis@staffbase.com', ptoBalance: 12, location: 'New York',      region: 'US', startDate: '2021-07-01' },
  { id: 'carol', name: 'Carol Davis',  email: 'carol.davis@staffbase.com',  role: 'manager',  department: 'Product',     title: 'Product Manager',        manager: 'eve@acme.com',              ptoBalance: 15, location: 'Austin',        region: 'US', startDate: '2020-01-20' },
  { id: 'dave',  name: 'Dave Wilson',  email: 'dave.wilson@staffbase.com',  role: 'employee', department: 'Design',      title: 'UX Designer',            manager: 'carol.davis@staffbase.com', ptoBalance: 9,  location: 'Berlin',        region: 'DE', startDate: '2022-04-11' },
  { id: 'erin',  name: 'Erin Patel',   email: 'erin@acme.com',              role: 'employee', department: 'Operations',  title: 'Office Worker',          manager: 'alice.chen@staffbase.com',  ptoBalance: 14, location: 'HQ',            region: 'US', startDate: '2023-08-22' },
