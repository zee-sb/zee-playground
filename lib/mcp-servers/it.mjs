...
const EMPLOYEES = [
  // Real staffbase personas (companion-internal ids that match the sign-in flow)
  { id: 'zee',   name: 'Zee Abuzeid',  email: 'zyad.abuzeid@staffbase.com', department: 'Product' },
  { id: 'alice', name: 'Alice Chen',   email: 'alice.chen@staffbase.com',   department: 'People' },
  { id: 'bob',   name: 'Bob Smith',    email: 'bob.smith@staffbase.com',    department: 'Engineering' },
  { id: 'carol', name: 'Carol Davis',  email: 'carol.davis@staffbase.com',  department: 'Product' },
  { id: 'dave',  name: 'Dave Wilson',  email: 'dave.wilson@staffbase.com',  department: 'Design' },
  // Legacy acme.com personas — kept for ticket/equipment seed-data continuity
