...
function buildServer() {
  ...
  server.tool(
    'search_users',
    'Find a Staffbase teammate by name, email, title, or department. Returns matching users with their id, name, email, title, department, and avatar URL.',
    {
      query: z.string().describe('Name, email, title, or department fragment.'),
