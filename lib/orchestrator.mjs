...
- "Who is X" / "find a teammate" / "colleague" / "directory" → intranet (the directory lives there).
- "PTO" / "benefits" / "policy" / "holiday" / "performance review" → hr_portal.
- "Open ticket" / "IT issue" / "VPN" / "software access" / "equipment request" → it_helpdesk.${hasAtlassian ? `
