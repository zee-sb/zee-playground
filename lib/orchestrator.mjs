...
- "Who is X" / "find a teammate" / "colleague" / "directory" → intranet (the real Staffbase directory lives there).
- "Who's my manager" / "who do I report to" / "my reporting line" / "my org" / "who are my direct reports" → hr_portal (the corporate org chart with manager/report links).
- "PTO" / "benefits" / "policy" / "holiday" / "performance review" / "my profile" / "my info" → hr_portal.
