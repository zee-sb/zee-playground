...
export const FLOWS = [
  ...
  },
  {
    ...
    tools: [
      ...
      { connectorId: 'intranet',  toolId: 'search_posts' },
    ],
    mode: 'suggested',
    instructions: 'Search the HR and IT knowledge bases first; fall back to intranet posts. Cite the exact document title in the answer.',
    onComplete: null,
    status: 'active',
  },
];
