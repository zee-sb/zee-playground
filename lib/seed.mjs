...
export const CONNECTORS = [
  ...
  },
  {
    ...
    description: 'Campsite posts · channels · leadership memos · spotlights',
    endpoint: '/api/mcp-intranet',
    authMethod: 'SSO (demo)',
    status: 'connected',
    domains: ['intranet', 'campsite', 'news', 'announcement', 'memo', 'spotlight', 'leadership', 'wiki', 'event'],
    writeTools: [],
    addedAt: 'May 10, 2026',
    tools: [
...
export const ASSISTANTS = [
  ...
  },
  {
    ...
    instructions: 'You are the Campsite Intranet assistant. Use the Intranet MCP (searchArticles, getArticle, listRecent) for live article retrieval. Use the Campsite Articles KB for curated leadership memo lookups. Always cite the article title.',
