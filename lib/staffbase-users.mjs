...
export const STAFFBASE_DIRECTORY = [
  ...
  { id: 'alice', email: 'alice.chen@staffbase.com',    name: 'Alice Chen',    department: 'People',      title: 'HR Manager',             avatar: 'AC' },
  { id: 'bob',   email: 'bob.smith@staffbase.com',     name: 'Bob Smith',     department: 'Engineering', title: 'Software Engineer',      avatar: 'BS' },
  { id: 'carol', email: 'carol.davis@staffbase.com',   name: 'Carol Davis',   department: 'Product',     title: 'Product Manager',        avatar: 'CD' },
  { id: 'dave',  email: 'dave.wilson@staffbase.com',   name: 'Dave Wilson',   department: 'Design',      title: 'UX Designer',            avatar: 'DW' },
];
