...
export const Modal = ({
  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-in fade-in duration-300">
      <div className={`bg-white rounded-2xl w-full max-w-[600px] shadow-2xl flex flex-col overflow-hidden animate-in slide-in-from-bottom-4 duration-500 ${panelClassName}`}>
        ...
        <div className={`p-6 overflow-y-auto max-h-[70vh] ${bodyClassName}`}>
          {children}
        </div>
        {footer && (
